# applications/poisson/group_rates_weighted_sum/fixed_effects_varying_slope/scripts/generate_true_params.R
...
# ✅ Anchor project root
# -------------------------------
suppressMessages(i_am("applications/poisson/group_rates_weighted_sum/fixed_effects_varying_slope/scripts/generate_true_params.R"))
