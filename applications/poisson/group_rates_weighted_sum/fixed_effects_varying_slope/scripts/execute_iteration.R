# applications/poisson/group_rates_weighted_sum/fixed_effects_regression/scripts/execute_iteration.R
...
# ✅ Anchor project root
# -------------------------------
suppressMessages(i_am("applications/poisson/group_rates_weighted_sum/fixed_effects_regression/scripts/execute_iteration.R"))
