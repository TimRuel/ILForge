# applications/poisson/group_rates_weighted_sum/random_intercepts_fixed_slopes/scripts/generate_true_params.R
...
# ✅ Anchor project root
# -------------------------------
suppressMessages(i_am("applications/poisson/group_rates_weighted_sum/random_intercepts_fixed_slopes/scripts/generate_true_params.R"))
